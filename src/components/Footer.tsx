  ...
  return (
    ...
    ">
      <div className="container-main flex flex-col gap-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 font-mono text-[11px] text-[var(--color-muted)]/80">
          <p>Noah Bucheton EI — SIRET en cours d’attribution</p>
          <p>Site édité par Noah Bucheton EI.</p>
        </div>
      </div>
    </footer>
  )
